...
function mapCategory(c: { id: string; name: string; iconName: string; _count?: { projects: number } }): Category {
  return {
    id: c.id,
    name: c.name,
    iconName: c.iconName,
...
export async function updateCategory(id: string, name: string, iconName: string): Promise<Category> {
